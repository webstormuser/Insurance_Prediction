...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self)->artifact_entity.ModelEvaluationArtifact:
        try:
            #we wiil compare saved models if saved models is empty the nthere will be no comparison for models
            ...
            if latest_dir_path == None:
                ...
                improved_r2_score=None)
                logging.info(f"Model evaluation artifact: {model_eval_artifact}")
                return model_eval_artifact

            #finding location of transformer object 
            ...
            logging.info(f" R2 score  using previous trained model: {previous_model_score}")
            ...
            logging.info(f" R2 score using current trained model: {current_model_score}")
