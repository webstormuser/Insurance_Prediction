...
from Insurance_Prediction.pipeline.batch_prediction import PredictPipeline,CustomData
...
if __name__=="__main__":
    try:
        ...
        output_file=predict_pipeline.start_batch_prediction(input_file_path=file_path)
        print(output_file)
